...
#ifndef TBB_CONCURRENT_QUEUE_CONCURRENT_MONITOR_IMPL_H
#define TBB_CONCURRENT_QUEUE_CONCURRENT_MONITOR_IMPL_H
...
#endif //TBB_CONCURRENT_QUEUE_CONCURRENT_MONITOR_IMPL_H
