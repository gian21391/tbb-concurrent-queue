...
#ifndef TBB_CONCURRENT_QUEUE_CACHE_ALIGNED_ALLOCATOR_IMPL_H
#define TBB_CONCURRENT_QUEUE_CACHE_ALIGNED_ALLOCATOR_IMPL_H

#include <tbb/header_only/tbb_config.h>
#include <tbb/header_only/cache_aligned_allocator.h>
#include <tbb/header_only/tbb_allocator.h>
#include <tbb/header_only/tbb_exception.h>
#include "tbb_misc.h"
#include "dynamic_link.h"
#include <cstdlib>

#if _WIN32||_WIN64
#include <tbb/header_only/machine/windows_api.h>
#else
#include <dlfcn.h>
#endif /* _WIN32||_WIN64 */
